        ...
        <div className="vendorsection">
          <div className="vendorleftbar">
            <div className="vendorselectedsection">
              ...
              <Link to={"/vendor/dashboard"} style={{textDecoration: "none", color: "rgb(66, 66, 66)"}}>
                <h3>Dashboard</h3>
              </Link>
            </div>
            <div className="vendorlinks">
              <div className="vendorlink" style={{backgroundColor: "#b5022c"}}>
          ...
          <div className="vendorrightcontent">
            <nav className="vendornavbar">
              ...
              <div className="vendornavbarsecondpart">
                ...
                >
                  <path
                    d="M5.49992 37.5833V18.8333C5.49992 15.5181 6.81688 12.3387 9.16108 9.99451C11.5053 7.6503 14.6847 6.33334 17.9999 6.33334C21.3151 6.33334 24.4946 7.6503 26.8388 9.99451C29.183 12.3387 30.4999 15.5181 30.4999 18.8333V37.5833M5.49992 37.5833H30.4999M5.49992 37.5833H1.33325M30.4999 37.5833H34.6666M15.9166 43.8333H20.0833"
                    stroke="black"
                    stroke-width="2.5"
                    stroke-linecap="round"
                    stroke-linejoin="round"
                  />
                  <path
                    d="M17.9998 6.33334C19.1504 6.33334 20.0832 5.4006 20.0832 4.25001C20.0832 3.09941 19.1504 2.16667 17.9998 2.16667C16.8492 2.16667 15.9165 3.09941 15.9165 4.25001C15.9165 5.4006 16.8492 6.33334 17.9998 6.33334Z"
                    stroke="black"
                    stroke-width="2.5"
                  />
                </svg>
                <div className="vendorprofilepicture"></div>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="40"
                  height="40"
